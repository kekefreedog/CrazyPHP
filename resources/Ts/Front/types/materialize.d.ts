/**
 * Materialize CSS TypeScript declarations with all internal declarations exported.
 *
 * Generated from: https://github.com/materializecss/materialize/blob/main/dist/js/materialize.d.ts
 * Materialize version: 2.3.3
 *
 * This file intentionally exports declarations that Materialize keeps local in
 * its upstream declaration file, including all *Options interfaces.
 */

/**
 * Base options for component initialization.
 */
export interface BaseOptions$1 {
}
export type MElement = HTMLElement | Element;
export type InitElements<T extends MElement> = NodeListOf<T> | HTMLCollectionOf<T>;
export type ComponentConstructor<T extends Component<O>, O extends BaseOptions$1> = {
    new (el: HTMLElement, options: Partial<O>): T;
};
export type ComponentType<C extends Component<O>, O extends BaseOptions$1> = ComponentConstructor<C, O> & typeof Component<O>;
 ...
 */
export declare class Component<O extends BaseOptions$1> {
    /**
...
export interface DropdownOptions extends BaseOptions$1 {
    /**
...
export interface AutocompleteOptions extends BaseOptions$1 {
    /**
...
export interface FloatingActionButtonOptions extends BaseOptions$1 {
    /**
...
export interface CardsOptions extends BaseOptions$1 {
    onOpen: (el: Element) => void;
    onClose: (el: Element) => void;
    inDuration: number;
    outDuration: number;
}
export declare class Cards extends Component<CardsOptions> implements Openable {
    #private;
    isOpen: boolean;
...
export interface CarouselOptions extends BaseOptions$1 {
    /**
...
export interface ChipsOptions extends BaseOptions$1 {
    /**
     * Set the chip data.
     * @default []
     */
...
export interface CollapsibleOptions extends BaseOptions$1 {
    /**
...
export interface DatepickerOptions extends BaseOptions$1 {
    /**
...
export interface MaterialboxOptions extends BaseOptions$1 {
    /**
     * Transition in duration in milliseconds.
     * @default 275
     */
...
export interface ModalOptions extends BaseOptions$1 {
    opacity: number;
    inDuration: number;
    outDuration: number;
...
export interface FormSelectOptions extends BaseOptions$1 {
    /**
...
export interface SidenavOptions extends BaseOptions$1 {
    /**
...
export interface SliderOptions extends BaseOptions$1 {
    /**
...
export interface TabsOptions extends BaseOptions$1 {
    /**
     * Transition duration in milliseconds.
     * @default 300
     */
...
export interface TimepickerOptions extends BaseOptions$1 {
    /**
     * Dial radius.
     * @default 135
     */
...
export interface ToastOptions extends BaseOptions$1 {
    /**
...
export interface TooltipOptions extends BaseOptions$1 {
    /**
...
export interface RangeOptions extends BaseOptions$1 {
}
...
export interface TapTargetOptions extends BaseOptions$1 {
    /**
...
export declare class CharacterCounter extends Component<object> {
    el: InputElement;
...
export interface ParallaxOptions extends BaseOptions$1 {
    /**
...
export interface PushpinOptions extends BaseOptions$1 {
    /**
...
export interface ScrollSpyOptions extends BaseOptions$1 {
    /**
 ...
 */
export declare function AutoInit(context?: HTMLElement, options?: Partial<AutoInitOptions>): void;
