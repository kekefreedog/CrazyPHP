...
export default class RadioType implements FormInputType {
     ...
     * Init
     *
     * Nothing to wire for a plain radio input
     *
     * @param inputEl
     * @returns {void}
     */
    public init = async (inputEl:HTMLInputElement|HTMLSelectElement, formEl:HTMLFormElement, helpers:FormInputTypeHelpers, options:Partial<FormOptions> = {}):Promise<void> => {
        ...
        // Init filter
        if(this._options.filter) await this._initFilter(inputEl, formEl, helpers);
    }
    ...
    public getMultiple = (itemEl:HTMLElement, options:Partial<FormOptions> = {}):null|Array<any>[] => {
        ...
        if(this._options.filter){
            ...
            // Get nultiple filter
            result = this._getMultipleFilter(itemEl);
     ...
     * @returns {void}
     */
    private _initFilter = async (inputEl:HTMLInputElement|HTMLSelectElement, formEl:HTMLFormElement, helpers:FormInputTypeHelpers):Promise<void> => {
